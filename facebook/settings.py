...
SECRET_KEY = 'django-insecure-9ly2mj)6n^swml8$1+g^e%%irde3s15^_1@cuu^&8=@d@w*m!d'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR/'facebookapp/TEMPLATES'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_URL = '/facebookapp/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'facebookapp/media')
